...
{
    public enum enum_hospital_report
    {
        GUID,
        hospital_name_guid,
        標題,
    ...
    /// 醫院問題回報
    /// </summary>
    public class hospital_reportClass
    {
        ...
        public List<hospital_report_picture_Class> pictures { get; set; }

   
    }
    public enum enum_hospital_report_picture
    {
        GUID,
    ...
    public class hospital_report_picture_Class
    {
        /// <summary>
        /// 唯一KEY
        /// </summary>
        ...
        /// 問題回報資料GUID索引鍵
        /// </summary>
        [JsonPropertyName("hospital_report_guid")]
        public string hospital_report_guid { get; set; }
        /// <summary>
        /// 圖片
        /// </summary>
